...
import { deleteCourseLecture, getCoursesLecture } from "../../Redux/Slices/LectureSlice.js";
       ...
       {lectures && lectures.length > 0 && <div className="flex justify-center gap-10 w-full">
          ...
          <ul className="w-[28rem] p-2 rounded-lg shadow-[0_0_10px_black] space-y-4">
            <li className="font-semibold text-xl text-rose-600 flex items-center justify-between">
              ...
              {role === "ADMIN" && (
                <button onClick={() => navigate("/course/addlecture", {state: {...state}})} className="py-2 px-3 text-white text-sm bg-orange-600 hover:bg-rose-600 transition-all ease-in-out duration-300 rounded-sm cursor-pointer font-semibold">
                  Add lecture
                </button>
              )}
            </li>
